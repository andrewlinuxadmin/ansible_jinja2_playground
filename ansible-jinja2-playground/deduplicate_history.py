...
def main():
  ...
  parser.add_argument(
      'history_file',
      nargs='?',
      default='ansible-jinja2-playground/conf/ansible_jinja2_playground_history.json',
      help='Path to history JSON file (default: ansible-jinja2-playground/conf/ansible_jinja2_playground_history.json)'
  )
  parser.add_argument(
      '--keep',
